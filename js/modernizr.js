 ...
 * Build: http://modernizr.com/download/#-fontface-applicationcache-canvas-canvastext-draganddrop-hashchange-history-audio-video-indexeddb-input-inputtypes-localstorage-postmessage-sessionstorage-websqldatabase-webworkers-geolocation-inlinesvg-smil-svg-svgclippaths-touch-webgl-addtest-prefixed-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-a_download-audio_audiodata_api-audio_webaudio_api-battery_api-battery_level-contextmenu-dataview_api-dom_dataset-event_deviceorientation_motion-file_api-forms_fileinput-forms_placeholder-forms_speechinput-forms_validation-fullscreen_api-gamepad-getusermedia-mathml-network_connection-network_eventsource-network_xhr2-notification-performance-pointerlock_api-script_async-script_defer-unicode-userdata-vibration-web_intents-webgl_extensions
 */
;
...
Modernizr.addTest('vibrate', !!Modernizr.prefixed('vibrate', navigator));// test if IE userdata supported
...
// By Theodoor van Donge
Modernizr.addTest('scriptasync', 'async' in document.createElement('script'));// https://developer.mozilla.org/en-US/docs/API/Pointer_Lock_API
...
Modernizr.addTest('performance', !!Modernizr.prefixed('performance', window));// Notifications
// By Theodoor van Donge
...
// By Addy Osmani
Modernizr.addTest('dataview', (typeof DataView !== 'undefined' && 'getFloat64' in DataView.prototype));// Web Audio API
